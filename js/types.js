(function (root) {
  ...
  byCode.INTJ.often = ["Elon Musk", "Mark Zuckerberg", "Michelle Obama", "Christopher Nolan"];
  ...
  byCode.INTP.often = ["Albert Einstein", "Bill Gates", "Marie Curie", "Rene Descartes"];
  ...
  byCode.ENTJ.often = ["Steve Jobs", "Margaret Thatcher", "Gordon Ramsay", "Franklin D. Roosevelt"];
  ...
  byCode.ENTP.often = ["Robert Downey Jr.", "Mark Twain", "Sacha Baron Cohen", "Leonardo da Vinci"];
  ...
  byCode.INFP.often = ["William Shakespeare", "J.R.R. Tolkien", "Johnny Depp", "Princess Diana"];
  ...
  byCode.ENFJ.often = ["Oprah Winfrey", "Barack Obama", "Martin Luther King Jr.", "Emma Watson"];
  ...
  byCode.ENFP.often = ["Robin Williams", "Ellen DeGeneres", "Robert Downey Jr.", "Will Smith"];
  ...
  byCode.ISTJ.often = ["George Washington", "Queen Elizabeth II", "Warren Buffett", "Natalie Portman"];
  ...
  byCode.ISFJ.often = ["Mother Teresa", "Kate Middleton", "Rosa Parks", "Beyonce"];
  ...
  byCode.ESTJ.often = ["Judge Judy", "Lyndon B. Johnson", "Sonia Sotomayor", "Martha Stewart"];
  ...
  byCode.ESFJ.often = ["Taylor Swift", "Jennifer Lopez", "Bill Clinton", "Sally Field"];
  ...
  byCode.ISTP.often = ["Clint Eastwood", "Michael Jordan", "Bear Grylls", "Kristen Stewart"];
  ...
  byCode.ISFP.often = ["Bob Dylan", "Frida Kahlo", "David Bowie", "Britney Spears"];
  ...
  byCode.ESTP.often = ["Donald Trump", "Madonna", "Jack Nicholson", "Eddie Murphy"];
  ...
  byCode.ESFP.often = ["Marilyn Monroe", "Miley Cyrus", "Jamie Foxx", "Elvis Presley"];
